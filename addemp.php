...
ID
                        ...
                        Identity Proof
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Identity" name="identity"
                                required="required">
                        </div>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                Joining Month
                                <div class="input-group">
                                    <input class="input--style-1" type="month" placeholder="Month" name="month"
                                        required="required">
                                </div>
                            </div>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                Daily Wase
                                <div class="input-group">
                                    <input class="input--style-1" type="number" name="base" placeholder="Base Salary">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                D.A.
                                <div class="input-group">
                                    <input class="input--style-1" type="number" name="da" placeholder="D.A.">
                            ...
                            <div class="col-2">
                                Deduction
                                <div class="input-group">
                                    <input class="input--style-1" type="int" name="deduction" placeholder="Deduction">
                                </div>
                            </div>
                        </div>
                        <!-- <div class="input-group">
