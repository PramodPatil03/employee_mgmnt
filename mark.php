...
$sql = "SELECT project.pid, project.eid, pname, duedate, subdate, mark, points, firstName, lastName,  total FROM `project` , `rank` ,`employee`, `salary`  WHERE project.eid = '$id' AND project.pid = '$pid'";
...
{ 
 ...
 $result = mysqli_query($conn, "UPDATE `project` SET `mark`='$mark',`subdate`='$subdate' WHERE eid=$eid and pid = $pid");
                    ...
                    <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Project Id</p>
                                     <input class="input--style-1" type="int" name="pid" value="<?php echo $pid;?>" readonly>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
