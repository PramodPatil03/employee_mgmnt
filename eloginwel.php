<?php 
	...
	$sql = "SELECT id, firstName, lastName,  points FROM employee, rank WHERE rank.eid = employee.id AND id = $id order by rank.points desc";
	...
	$sql4 = "SELECT status FROM `employee_leave`";
